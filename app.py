    ...
    try:
        ...
        if mostrar_analise:
            try:
                ...
                scores_esg_ind = [aplicar_faixas(v, ind["faixas"]) for v, ind in zip(respostas_esg, indicadores_esg)]
                scores_fin_ind = [aplicar_faixas(v, ind["faixas"]) for v, ind in zip(respostas_financeiros, indicadores_financeiros)]
